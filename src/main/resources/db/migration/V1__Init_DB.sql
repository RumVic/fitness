...
ALTER TABLE IF EXISTS app.user_fitness
    OWNER to postgres;
...
(
    ...
    lifestyle character varying(255) COLLATE pg_catalog."default",
...
ALTER TABLE IF EXISTS app.profile_fitness
    OWNER to postgres;
...
CREATE TABLE IF NOT EXISTS app.product_fitness
    ...
    ALTER TABLE IF EXISTS app.product_fitness
        OWNER to postgres;
...
ALTER TABLE IF EXISTS app.dish_fitness
    OWNER to postgres;
...
ALTER TABLE IF EXISTS app.diary_food_fitness
    OWNER to postgres;
...
ALTER TABLE IF EXISTS app.composition_dish_fitness
    OWNER to postgres;
...
ALTER TABLE IF EXISTS app.audit_fitness
    OWNER to postgres;
